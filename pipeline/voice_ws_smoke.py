...
def voice_ws_url(base: str, context: str = "") -> str:
    parsed = urlparse(base.rstrip("/"))
    scheme = "wss" if parsed.scheme == "https" else "ws"
    query = urlencode({"context": context[-1400:]}) if context else ""
        ...
        async with websockets.connect(url, open_timeout=30) as ws:
            ...
            while asyncio.get_running_loop().time() < deadline:
                ...
                if msg.get("type") == "tool_calls":
                    ...
                    saw_tool = any(call.get("name") == expected_tool for call in tool_calls)
            ...
            case_ok = saw_tool and not saw_error and (saw_transcript or saw_completion)
            ...
            if text:
                ...
                context_lines.append(f"Gemini: {text[:700]}")
